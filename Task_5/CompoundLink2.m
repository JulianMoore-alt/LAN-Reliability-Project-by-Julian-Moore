function point = CompoundLink2(K, p1, p2, p3)
    ...
    for i = 1:99
        ...
        chanceOfFailure(end + 1) = p2n; % Storing the current probability p2n in the chanceOfFailure array
      
        p2n = p2n + 0.01; % Incrementing p2n for the next iteration.
    end
