function point = CompoundLink3(K, p1, p2, p3)
    ...
    for i = 1:99
        ...
        chanceOfFailure(end + 1) = p1n; % Storing the current probability p1n in the chanceOfFailure array
      
        p1n = p1n + 0.01; % Incrementing p1n for the next iteration.
    end
